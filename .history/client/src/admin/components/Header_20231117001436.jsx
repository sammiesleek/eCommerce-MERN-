...
const Header = () => {
  return (
    <div className="flex fixed left-0 right-0 top-0 py-2  px-10 border-b">
      <div className="flex w-full h-full  justify-between bg-red-500">
        <div className="span  flex justify-center items-center bg-gray-300">
        ...
        <div className="flex justify-center items-center h-full">
          <ul className="navbar-nav flex justify-center items-center gap-x-6 ">
            <Dropdown
              as="li"
            ...
            >
              <Dropdown.Toggle
                variant=""
                as="a"
                className="nav-link cursor-pointer flex justify-center items-center"
              >
                <span className="w-9 h-9 flex">
                  <img
              ...
              <Dropdown.Menu
                align="right"
                className="mt-3 dropdown-menu dropdown-menu-end bg-white px-4 py-5 shadow-sm"
                style={{
                  position: "absolute",
                  inset: "unset",
                  transform: "translate3d(0px, 84px, 0px)",
