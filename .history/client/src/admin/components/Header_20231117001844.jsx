  ...
  return (
    <div className="flex fixed left-0 right-0 top-0   px-10 border-b">
      <div className="flex w-full h-full  justify-between ">
        ...
        <div className="flex justify-center items-center h-full w-full bg-green-500">
          <ul className=" flex justify-center items-center gap-x-6 h-full bg-red-500 ">
            <Dropdown
              as="li"
            ...
            >
              ...
              <Dropdown.Menu
                align="right"
                className="mt-3 dropdown-menu dropdown-menu-end bg-white px-2 py-3 shadow-sm"
                style={{
                  position: "absolute",
                  inset: "unset",
                  transform: "translate3d(0px, 84px, 0px)",
