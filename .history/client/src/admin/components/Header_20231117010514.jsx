              ...
              >
                <ul className="">
                  <li className="flex justify-center">
                    <span className="flex w-8 h-8 rounded-full bg-red-500">
                      <img
                    ...
                    <div className="timeline-panel">
                      ...
                      <span className="flex">
                        <p className="py-1 px-2 w-fit text-xs rounded-sm flex m-0 justify-center items-center bg-red-400 w-fit">
                          stockout
                        </p>
                        <p>Dec 12 2023- 12:40pm</p>
                      </span>
                    </div>
                  </li>
                </ul>
