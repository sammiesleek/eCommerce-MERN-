            ...
            <Dropdown as="li" className="nav-item dropdown ">
              ...
              >
                <ul className="flex w-full flex-col p-0 ">
                  <li className="flex items-center w-full gap-x-4 px-2">
                    ...
                    >
                      ...
                      <span className="flex items-center">
                        <p className="py-0 px-2 h-fit text-xs rounded-sm flex m-0 justify-center items-center bg-red-200 text-red-700 font-semibold">
                          stockout
                        </p>
