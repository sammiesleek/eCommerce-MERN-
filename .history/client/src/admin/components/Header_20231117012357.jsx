                ...
                <ul className="flex w-full flex-col p-0 ">
                  <li className="flex items-center w-full gap-x-2 px-2 py-2">
                    ...
                    >
                      ...
                      <span className="flex items-center">
                        <p className="py-[0.5px] px-2 h-fit text-[10px] rounded-xl flex m-0 justify-center items-center bg-red-200 text-red-700 font-semibold">
                          stockout
                        </p>
                        <p className="mb-0 ml-3 text-sm  text-gray-600">
                          Dec 12 2023- 12:40pm
                        </p>
                      </span>
                    </div>
                  ...
                  <li className="flex items-center w-full gap-x-2 px-2 py-2">
                    ...
                    >
                      <span>Stock out , please kind restock.</span>
                      <span className="flex items-center">
                        <p className="py-1 px-2 h-fit text-xs rounded-sm flex m-0 justify-center items-center bg-red-200 text-red-700 font-semibold">
                          stockout
                        </p>
                        <p className="mb-0 ml-3 text-sm  text-gray-600">
                          Dec 12 2023- 12:40pm
