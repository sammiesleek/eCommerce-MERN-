              ...
              >
                <ul className="flex w-full flex-col p-0 ">
                  <li className="flex items-center w-full gap-x-2 px-2 py-2">
                    ...
                    flex-col"
                    >
                      <span className=" flex justify-center font-semibold text-left text-gray-700">
                        Stock out , please kind restock.
                      </span>
                      <span className="flex justify-center">
                        <p className="py-[2px] text-left px-2 h-fit text-[10px] rounded-xl flex m-0 justify-center items-center bg-red-200 text-red-700 font-semibold">
                          stockout
                        </p>
