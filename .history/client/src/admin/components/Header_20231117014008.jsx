  ...
  return (
    <div className="flex fixed left-0 right-0 top-0   px-10 border-b">
      <div className="flex w-full h-full  justify-between ">
        ...
        <div className="flex justify-center items-center bg-red200">
          <ul className=" flex justify-center items-center gap-x-6  bg-red-500">
            <Dropdown as="li" className="nav-item dropdown flex">
              <Dropdown.Toggle
