...
const Header = () => {
  return (
    <div className="flex fixed left-0 right-0 top-0 py-3  px-10 border-b">
        ...
        <div className="flex justify-center items-center">
          <ul className=" flex justify-center items-center gap-x-6 my-auto  ">
            <Dropdown as="li" className="nav-item dropdown my-auto flex ">
              <Dropdown.Toggle
                className=" flex justify-center flex-col  flex-wrap cursor-pointer h-[32px] w-[32px] bg-slate-500"
                variant=""
                as="a"
              >
                <span>
