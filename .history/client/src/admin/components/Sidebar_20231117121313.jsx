  ...
  return (
    <div className="fixed w-screen h-screen flex ">
      ...
      <div className="flex w-[250px] flex-col border-r bg-white">
        ...
        <span className="flex gap-x-2 justify-center w-[80%] mx-auto mb-4 items-center font-semibold text-white bg-[#10B981]  py-[12px] rounded-md cursor-pointer hover:bg-[#555962] transition-all ease-linear ">
          <Logout
            theme="outline"
            size="18"
            strokeWidth={5}
