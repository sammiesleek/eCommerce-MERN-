          ...
          <MetisMenu toggle={false} className="pl-0">
            {content.map((item, index) => (
              <li key={index}>
                <Link
                  to=""
                  className="flex  no-underline gap-x-3 py-2 pl-4 bg-black  text-[#555962] font-semibold hover:text-[#10B981] transition-all ease-linear"
                >
                  {item.icon}
                  <span>{item.label}</span>
                </Link>
                <ul className=" w-fit p-2 ml-10 ">
                  {item.content &&
