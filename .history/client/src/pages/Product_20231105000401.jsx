              ...
              <div className="flex flex-col">
                <div className="flex flex-col border-b ">
                  <span className=" flex items-center">
                    ...
                    <Like
                      className="flex cursor-pointer text-black bg-transparent hover:bg-[#CEA384] hover:text-white transition-all ease-in-out rounded-full p-2 border ml-5 hover:border-transparent"
                      theme="outline"
                      size="18"
                      strokeWidth={3}
                    />
                  ...
                  <div className="flex mt-10 gap-x-4  w-fit flex-col gap-y-4">
                    <div className="flex gap-x-4 ">
                      ...
                      <button
                        ...
                        className=" px-10 flex justify-center items-center h-full bg-[#CEA384] hover:bg-black text-white transition-all ease-linear font-semibold "
                      >
                        ADD TO CART
                      </button>
                    </div>
                    <button
                      style={{ letterSpacing: "2px" }}
                      className=" px-10 flex justify-center items-center h-auto hover:bg-[#CEA384] bg-black text-white transition-all ease-linear font-semibold "
                    >
                      BUY IT NOW
                    </button>
                    <span className="flex items-center">
