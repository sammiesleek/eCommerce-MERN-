        ...
        <div className="flex flex-col">
          ...
          <div className="flex  flex-col gap-y-3 mt-5">
            <div className="flex items-center gap-x-4">
              <p className="font-normal text-lg border-b border-b-black">
                5 star
              </p>
              <span className="w-[400px] h-4 bg-gray-200 flex">
            ...
            <div className="flex items-center gap-x-4">
              ...
              <span className="w-[400px] h-4 bg-gray-200 flex">
                <span className="w-[80%] h-full bg-black"></span>
              </span>
            </div>
            <div className="flex items-center gap-x-4">
              <p className="font-normal text-lg border-b border-b-black">
              ...
              <span className="w-[400px] h-4 bg-gray-200 flex">
                <span className="w-[60%] h-full bg-black"></span>
              </span>
            </div>
            <div className="flex items-center gap-x-4">
              <p className="font-normal text-lg border-b border-b-black">
              ...
              <span className="w-[400px] h-4 bg-gray-200 flex">
                <span className="w-[40%] h-full bg-black"></span>
              </span>
            </div>
            <div className="flex items-center gap-x-4">
              <p className="font-normal text-lg border-b border-b-black">
              ...
              <span className="w-[400px] h-4 bg-gray-200 flex">
                <span className="w-[10%] h-full bg-black"></span>
              </span>
            </div>
          </div>
        </div>
