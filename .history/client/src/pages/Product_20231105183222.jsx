    ...
    <div className="flex flex-col">
      ...
      <div className="flex mt-10 max-w-[1400px] px-3">
        <div className="flex flex-col">
          ...
          <div className="flex mt-5 font-bold text-lg flex-col">
            <p>Submit Review </p>
            <div className="flex flex-col">
              ...
              <button className="flex justify-center items-center py-2 px-5 w-fit bg-[#CEA384] mt-4 text-white hover:bg-black">
                Submit
              </button>
            </div>
          </div>
