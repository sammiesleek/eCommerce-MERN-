    ...
    <div className="flex flex-col">
      ...
      <div className="flex mt-10 max-w-[1400px] px-3 ">
        <div className="flex flex-col  max-w-fit">
          ...
          <div className="flex bg-purple-950 flex-col lg:flex-row ">
            <div className="flex  flex-col gap-y-3 mt-5 w-full lg:w-1/2 bg-slate-700">
            ...
            <div className="flex mt-5 font-bold text-lg flex-col bg-green-800 w-full lg:w-1/2">
              <p>Submit Review </p>
              <div className="flex flex-col">
            ...
            <div className="flex flex-col mt-10 bg-red-400 w-full lg:w-1/2">
              <div className="flex">
