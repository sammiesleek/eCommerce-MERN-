  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col product_page min-h-screen w-full relative  pt-20 ">
        <div className="flex flex-col max-w-[1400px] mx-auto w-full px-3 bg-red-400">
      ...
      <div className="flex mt-10 max-w-[1400px] px-3  mx-auto bg-green-300">
        <div className="flex flex-col  w-full">
          <h1 className="font-bold text-xl">Ratings + Reviews</h1>
          <div className="flex bg-purple-950 flex-col   flex-wrap w-full">
            <div className="flex  flex-col gap-y-3 mt-5 w-full lg:w-[45%] bg-slate-700">
            ...
            <div className="flex mt-5 font-bold text-lg flex-col bg-green-800 w-full lg:w-[45%]">
              <p>Submit Review </p>
              <div className="flex flex-col">
            ...
            <div className="flex flex-col mt-10 bg-red-400 w-full lg:w-[45%]">
              <div className="flex">
