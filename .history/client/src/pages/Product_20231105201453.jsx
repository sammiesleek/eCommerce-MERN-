...
const Product = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex mt-10 w-full max-w-[1400px] mx-auto  ">
        <div className="flex flex-col  w-full">
          <h1 className="font-bold text-xl">Ratings + Reviews</h1>
          <div className="flex flex-col">
            <div className="flex flex-col lg:flex-row  bg-green-600 w-full">
              <div className="flex  flex-col gap-y-3 mt-5 w-full lg:w-[50%]">
              ...
              <div className="flex mt-5 font-bold text-lg flex-col w-full lg:w-[5%]">
                <p>Submit Review </p>
                <div className="flex flex-col">
            ...
            <div className="flex flex-col mt-10  w-full lg:w-[45%]">
              <div className="flex">
