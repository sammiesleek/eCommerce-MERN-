...
const Product = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex mt-10 w-full max-w-[1400px] mx-auto  px-4 ">
        <div className="flex flex-col  w-full">
          <h1 className="font-bold text-xl">Ratings + Reviews</h1>
          <div className="flex flex-col ">
            <div className="flex flex-col  lg:flex-row  bg-red-500">
              <div className="flex  flex-col gap-y-3 w-full   lg:w-[50%] bg-purple-800">
              ...
              <div className="flex  flex-col w-full lg:w-[50%] bg-yellow-700">
                <p>Submit Review </p>
                <div className="flex flex-col">
